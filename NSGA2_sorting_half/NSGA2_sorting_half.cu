...
__global__ void FastSortSolution(int *d_sorted_array, bool *F_set, bool *Sp_set, float *d_objval, Sol *d_sol_struct, int *d_rank_count, int *d_np)
{
    ...
    if (count > (c_sort_popsize / 2))
    {
        ...
        // 여기가 확률만큼 rank 0에서 뽑는데 중복되는것
        if (g.thread_rank() < (c_sort_popsize / 2))
        {
            d_sorted_array[g.thread_rank()] = d_sol_struct[g.thread_rank() % c_cutted_popsize].sol_idx;
        }
...
int main()
{
    ...
    const char *ff_result[] = {
        "/home/jeus5771/CUDA_protein/NSGA2_sorting_half/NSGA2_sorting_half_result/NSGA2_sorting_half_reuslt1.csv",
        "/home/jeus5771/CUDA_protein/NSGA2_sorting_half/NSGA2_sorting_half_result/NSGA2_sorting_half_reuslt2.csv",
        "/home/jeus5771/CUDA_protein/NSGA2_sorting_half/NSGA2_sorting_half_result/NSGA2_sorting_half_reuslt3.csv",
        "/home/jeus5771/CUDA_protein/NSGA2_sorting_half/NSGA2_sorting_half_result/NSGA2_sorting_half_reuslt4.csv",
        "/home/jeus5771/CUDA_protein/NSGA2_sorting_half/NSGA2_sorting_half_result/NSGA2_sorting_half_reuslt5.csv",
        "/home/jeus5771/CUDA_protein/NSGA2_sorting_half/NSGA2_sorting_half_result/NSGA2_sorting_half_reuslt6.csv"};
